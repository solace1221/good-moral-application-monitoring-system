...
<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-64'"
  ...
  <nav>
    ...
    <a href="{{ route('admin.organizations.index') }}"
      class="gap-2 h-20 items-center flex px-4 py-2 {{ request()->routeIs('admin.organizations.*') ? 'bg-gray-800 text-spupGold' : 'text-white hover:bg-gray-800 hover:text-spupGold' }}">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-10">
