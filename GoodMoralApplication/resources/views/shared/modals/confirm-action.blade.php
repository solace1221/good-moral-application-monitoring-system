{{--
  ...
  Use with @component / @endcomponent:

    @component('shared.modals.confirm-action', [
  ...
  Variables (passed as second argument array):
    ...
    closeFn     – JS called by cancel/× button   (default: auto-computed)
    maxWidth    – Inner card max-width           (default: '500px')
    zIndex      – Overlay z-index                (default: '1000')
--}}
@php
    $title      = $title      ?? 'Confirm Action';
    $titleColor = $titleColor ?? '#1f2937';
