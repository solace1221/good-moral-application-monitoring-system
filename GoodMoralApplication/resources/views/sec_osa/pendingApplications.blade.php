<x-dashboard-layout>
  ...
  <div class="header-section">
    ...
    <p class="welcome-text">Applications ready for certificate printing</p>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      @if($receipt && $receipt->document_path)
                        <a href="{{ route('files.serve', $receipt->document_path) }}" target="_blank" class="btn btn-sm btn-info">
                          View Receipt
                        </a>
                      @else
                        No Receipt
