...
function openEscModal(i) {
        ...
        <div style="background:white;border:1px solid #e5e7eb;border-left:3px solid #f59e0b;border-radius:6px;padding:10px 12px;">
          <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:8px;">
            ...
            <div style="text-align:right;flex-shrink:0;">
              ...
              <span style="display:inline-block;padding:2px 8px;border-radius:4px;font-size:10px;font-weight:600;color:white !important;background:${sc};">${sl}</span>
            </div>
          </div>
        </div>`;
  });
    ...
    html += `
      <div style="display:flex;flex-direction:column;gap:8px;">
        ...
        <div style="display:flex;gap:10px;align-items:center;font-size:13px;">
          ...
          <span style="display:inline-block;padding:3px 12px;border-radius:20px;font-size:11px;font-weight:700;text-transform:uppercase;background:#f97316;color:white !important;">Escalated</span>
        </div>
      </div>`;
  } else {
    html += `
  ...
  // Footer — view-only (Close button only)
  document.getElementById('escModalFooter').innerHTML = `<button onclick="closeEscModal()" style="padding:8px 20px;background:white;color:#374151;border:1px solid #d1d5db;border-radius:6px;font-size:13px;font-weight:600;cursor:pointer;">Close</button>`;
