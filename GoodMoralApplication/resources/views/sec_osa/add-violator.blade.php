<x-dashboard-layout>
  ...
  <div class="container">
    ...
    <div class="card shadow-sm card-standard">
      ...
      <form method="POST" action="{{ route('sec_osa.storeViolator') }}" onsubmit="return validateAndPrepareForm()" style="display: grid; gap: 20px;">
        @csrf
    ...
    <div style="background: #f8f9fa; padding: 20px; border-radius: 12px; border-left: 4px solid var(--primary-green); margin-top: 24px;">
      ...
      <p style="margin: 0; color: #495057; line-height: 1.5;">
        ...
        Select the offense type, choose the violation, search for the student, and submit.
      </p>
    </div>
  </div>
