...
<!-- OFFICER ROLE -->
@if(Auth::user()->account_type === 'student' && Auth::user()->role === 'student')
<div class="sidebar-section">OFFICER ROLE</div>
<a href="{{ route('student.applyOfficer') }}"
   class="nav-link {{ request()->routeIs('student.applyOfficer') ? 'active' : '' }}">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="nav-icon">
    <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
  </svg>
  Apply for Student Officer Role
</a>
@endif
