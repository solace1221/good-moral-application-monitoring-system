...
<div class="nav-section" data-section="applications">
  <div class="nav-section-header" onclick="toggleDropdown('applications')">
    ...
    <span class="nav-section-title">Good Moral Application</span>
...
<div class="nav-section" data-section="accounts">
  <div class="nav-section-header" onclick="toggleDropdown('accounts')">
    <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
  ...
  <div class="nav-submenu" id="submenu-accounts">
...
<div class="nav-section" data-section="violations">
  <div class="nav-section-header" onclick="toggleDropdown('violations')">
    ...
    <span class="nav-section-title">Violations</span>
    <svg xmlns="http://www.w3.org/2000/svg" class="nav-chevron" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
      <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
    </svg>
  </div>
  <div class="nav-submenu" id="submenu-violations">
    ...
    <a href="{{ route('admin.AddViolator') }}?mode=multiple" class="nav-sublink {{ request()->routeIs('admin.AddViolator') && request()->get('mode') == 'multiple' ? 'active' : '' }}">
      <svg xmlns="http://www.w3.org/2000/svg" class="nav-subicon" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
...
<div class="nav-section" data-section="management">
  ...
  <div class="nav-submenu" id="submenu-management">
    ...
    <a href="{{ route('admin.academic-year.index') }}" class="nav-sublink {{ request()->routeIs('admin.academic-year.*') ? 'active' : '' }}">
      <svg xmlns="http://www.w3.org/2000/svg" class="nav-subicon" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
        <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5" />
      </svg>
      Academic Years
    </a>
    <a href="{{ route('admin.designations.index') }}" class="nav-sublink {{ request()->routeIs('admin.designations.*') ? 'active' : '' }}">
      <svg xmlns="http://www.w3.org/2000/svg" class="nav-subicon" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
...
<!-- Profile -->
<a href="{{ route('profile.admin') }}" class="nav-link {{ request()->routeIs('profile.admin') ? 'active' : '' }}">
  <svg xmlns="http://www.w3.org/2000/svg" class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
...
document.addEventListener('DOMContentLoaded', function() {
  const sections = ['applications', 'accounts', 'violations', 'reports'];
  ...
  // Check if current route is in Accounts section
  if (currentRoute.includes('/admin/AddAccount') ||
      currentRoute.includes('/admin/psgApplication')) {
    const accountsSection = document.querySelector('[data-section="accounts"]');
    if (accountsSection) {
      accountsSection.classList.remove('collapsed');
    }
  }

  // Check if current route is in Violations section
  ...
  // Check if current route is in Academic Year section
  if (currentRoute.includes('/admin/academic-year')) {
    const academicYearSection = document.querySelector('[data-section="academic-year"]');
    if (academicYearSection) {
      academicYearSection.classList.remove('collapsed');
    }
  }

  // Profile route doesn't need auto-expansion as it's a single link
