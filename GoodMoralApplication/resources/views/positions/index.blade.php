  ...
  <div class="header-section">
    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
      ...
      <div style="display: flex; gap: 12px; align-items: center;">
        <a href="{{ route('admin.positions.create') }}" class="btn-primary" style="padding: 10px 16px; font-size: 14px; text-decoration: none; display: flex; align-items: center; gap: 8px;">
              ...
              <tr class="border-b hover:bg-gray-50">
                ...
                <td class="px-6 py-4 text-sm text-gray-600">
                  <div class="flex gap-2">
                    <a href="{{ route('admin.positions.edit', $position->position_id) }}" class="bg-blue-500 hover:bg-blue-700 text-white px-3 py-1 rounded-md text-xs">
                      Edit
                    </a>
                    <form action="{{ route('admin.positions.destroy', $position->position_id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this position?');">
                      @csrf
                      @method('DELETE')
