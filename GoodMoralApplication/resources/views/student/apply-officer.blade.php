...
<x-dashboard-layout>
  ...
  <div class="header-section">
    <div style="display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 16px;">
      <div style="flex: 1; min-width: 250px;">
        <h1 class="responsive-title role-title">Apply for Student Officer Role</h1>
        <p class="responsive-text welcome-text">Submit your application to become a Student Officer</p>
  ...
  <div class="header-section">
    @if($approvedApplication)
      {{-- Student is already an approved Student Officer --}}
      <div style="text-align: center; padding: 40px 20px; background: #d4edda; border-radius: 12px; border: 2px solid #28a745;">
        ...
        <h3 style="color: #155724; font-size: 20px; margin-bottom: 8px;">You are an Approved Student Officer</h3>
        <p style="color: #155724; font-size: 14px;">Your Student Officer application has been approved. You can access the Student Officer dashboard.</p>
    ...
    @elseif($pendingApplication)
      ...
      <div style="text-align: center; padding: 40px 20px; background: #fff3cd; border-radius: 12px; border: 2px solid #ffc107;">
        ...
        <p style="color: #856404; font-size: 14px;">Your Student Officer application is under review. You will be notified once a decision is made.</p>
    ...
    @else
      ...
      <div style="background: white; padding: 32px; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05);">
        <h3 style="font-size: 18px; font-weight: 700; color: #1f2937; margin-bottom: 8px;">Student Officer Application Form</h3>
        <p style="color: #6b7280; font-size: 14px; margin-bottom: 24px;">Fill out the form below to apply for a Student Officer position. Your existing student information will be used.</p>
        ...
        <form method="POST" action="{{ route('student.submitOfficerApplication') }}">
          @csrf
  ...
  <script>
    function loadPositions(organizationId) {
      ...
      fetch(`/student/officer-positions/${organizationId}`)
