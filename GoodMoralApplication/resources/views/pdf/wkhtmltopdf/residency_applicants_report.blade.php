...
<head>
    ...
    <title>Certificate of Residency Applicants Report</title>
    <style>
        @page {
            size: 8.5in 11in;
            margin: 0.5in;
...
<body>
    ...
    <div class="report-page">
        ...
        <div style="text-align: center; margin: 20px 0;">
            <div style="font-size: 14pt; font-weight: bold; margin-bottom: 10px;">APPLICATION OF CERTIFICATE OF RESIDENCY</div>
        ...
        <table class="applications-table">
            <thead>
                <tr>
                    <th style="width: 15%;">DATE OF<br>APPLICATION</th>
                    <th style="width: 25%;">NAME</th>
                    <th style="width: 20%;">REASON</th>
                    <th style="width: 20%;">COURSE YEAR/<br>COURSE<br>COMPLETED</th>
                    <th style="width: 20%;">SEMESTER AND<br>SCHOOL YEAR<br>LAST<br>ATTENDED/<br>DATE OF<br>GRADUATION</th>
                </tr>
            </thead>
            <tbody>
