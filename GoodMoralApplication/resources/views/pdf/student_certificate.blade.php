...
<body>
  @php
    ...
    $spupLogo = base64_encode(file_get_contents(public_path('images/backgrounds/spup-logo.png')));
    // OSA logo - you'll need to add the actual OSA logo file to public/images/osa-logo.png
    $osaLogo = file_exists(public_path('images/osa-logo.png')) ? base64_encode(file_get_contents(public_path('images/osa-logo.png'))) : null;
  ...
  <div class="content">
    ...
    <p style="margin-bottom: 0; line-height: 1.2;">
      This is to certify that <strong>{{ $title }} {{ $formattedName }}</strong> is a student of the
      ...
      <strong>
        ...
        [Unknown Program]
        @endif
      </strong> for {{ $studentDetails1->last_semester_sy ?? $application->last_semester_sy ?? 'the academic period' }}.
      In {{ $possessivePronoun }} stay in the University, {{ $subjectPronoun }} has never been subjected to any disciplinary sanction. It is further certified that {{ $subjectPronoun }} is of good moral character.
    </p>
