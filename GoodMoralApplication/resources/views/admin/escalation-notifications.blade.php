    ...
    <div style="display: grid; gap: 20px;">
      ...
      <div style="background: white; border-radius: 12px; padding: 24px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.08);
        ...
        <div style="display: flex; gap: 12px; flex-wrap: wrap;">
          ...
          @if($notification['escalation_status'] !== 'escalated')
          <button onclick="triggerEscalation('{{ $notification['student_id'] }}')"
                  style="padding: 8px 16px; background: #dc3545; color: white; border: none; border-radius: 6px; font-size: 14px; font-weight: 500; cursor: pointer;">
...
function triggerEscalation(studentId) {
  if (confirm('Are you sure you want to manually trigger escalation for this student? This will create a major violation.')) {
    // You can implement the manual escalation logic here
